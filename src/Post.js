...
let elems = {
    ...
    content: 'THIS IS A POST ABOUT DINOS LISTEN UP DUDERS'
}

let commentStuff = [
    {
        commentHeader: 'Dinobama',
        commentBody: 'Rawr'

    }, {
        commentHeader: 'Dinodelray',
        commentBody: 'XD'
    }
];
...
class Content extends Component {
    ...
    changeContent(e) {
        ...
        let answer = prompt("What would you like to update the body to say?");
        // update state
